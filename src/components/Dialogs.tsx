  ...
  const sections = [
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { keys: [`${modifierLabel}+F`], description: "Find and replace in the current note" },
        { keys: [`${modifierLabel}+Shift+P`], description: "Open selection actions palette" },
        { keys: [`${modifierLabel}+${alternateModifierLabel}+P`], description: "Toggle focused preview and return from revision diff" },
        { keys: [`${alternateModifierLabel}+PageUp`, `${alternateModifierLabel}+PageDown`], description: "Jump between saved revisions" },
        { keys: [`${alternateModifierLabel}+↑`, `${alternateModifierLabel}+↓`], description: "Move selected line block up / down" },
        { keys: [`${alternateModifierLabel}+Shift+↑`, `${alternateModifierLabel}+Shift+↓`], description: "Move current heading section up / down" },
        { keys: [`${modifierLabel}+Shift+D`], description: "Duplicate current line or selection" },
        { keys: [`${modifierLabel}+${alternateModifierLabel}+1`, `${modifierLabel}+${alternateModifierLabel}+2`, `${modifierLabel}+${alternateModifierLabel}+3`], description: "Apply heading levels 1-3" },
        { keys: [`${modifierLabel}+Shift+8`], description: "Toggle bullet list" },
        { keys: [`${modifierLabel}+Shift+9`], description: "Toggle task list" },
        { keys: [`${modifierLabel}+H`], description: "Open in-note find / replace" },
