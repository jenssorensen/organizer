...
export function TrashPanel({
  ...
  return (
    <div className="dialog-backdrop" role="presentation" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div aria-labelledby="trash-panel-title" className="dialog-card trash-dialog" role="dialog">
        <div className="dialog-card__header">
          <div>
          ...
          <div className="trash-panel__header-actions">
            ...
            <button aria-label="Close trash" className="icon-action" onClick={onClose} title="Close" type="button"><X size={16} /></button>
          </div>
        </div>
        {entries.length === 0 ? (
